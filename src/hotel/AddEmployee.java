...
public class AddEmployee extends JFrame  {
    ...
    public AddEmployee(){
        ...
        JLabel AddPasseneger = new JLabel("ADD EMPLOYEE DETAILS");
        AddPasseneger.setForeground(Color.BLUE);
        AddPasseneger.setFont(new Font("Tahoma",Font.PLAIN,31));
        AddPasseneger.setBounds(450,24,442,35);
        add(AddPasseneger);
